...
public class CommUnitsTest {

    @Test
    public void loadProperties() {
        String fileName = "datasource.properties";
        Properties properties = CommUnits.loadProperties(fileName);
    ...
    public void gsonTest1() {
        ...
        String jsonStr = CommUnits.object2Json(user);
    ...
    public void gsonTest2() {
        ...
        User user = (User) CommUnits.json2Object(jsonStr,User.class);
